...
private const val TEST_URL = "https://www.prenatal.nl/product/123"

class PrenatalPriceParserTest {

    private lateinit var parser: PrenatalPriceParser
    private lateinit var document: Document
    private lateinit var priceElement: Element

    @BeforeEach
    fun setUp() {
        parser = PrenatalPriceParser()
